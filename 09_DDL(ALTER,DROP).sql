...
-- 2) 삭제 : ALTER TABLE 테이블명 DROP CONSTARINT 제약조건명;
...
ALTER TABLE DEPT_COPY 
MODIFY DEPT_TITLE NULL; -- DEPT_TITLE 컬럼을 NULL 가능하게 수정
...
SELECT * FROM TB2; --> 더 이상 FK제약 조건 걸린 게 아니라 단순히 NUMBER TYPE DATA일 뿐이다.
