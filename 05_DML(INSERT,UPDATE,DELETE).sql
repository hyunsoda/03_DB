...
UPDATE EMPLOYEE2 SET BONUS = 0.1 WHERE BONUS IS NULL; -- 15행 수정
...
-- EPLOYEE2 테이블에서 평소에 유재식을 부러워하던 방명수 사원의 급여와 보너스율을 
...
SALARY = (SELECT SALARY FROM EMPLOYEE2 WHERE EMP_NAME = '유재식'), -- 유재식의 급여 --3400000
BONUS = (SELECT BONUS FROM EMPLOYEE2 WHERE EMP_NAME = '유재식') -- 유재식의 보너스율 -- 0.2
WHERE EMP_NAME = '방명수';
...
INSERT INTO EMP_M02
VALUES (999, '곽두원', '561016-1234567', 'kwak_dw@kh.or.kr', '01011112222','D9', 'J4','S1',9000000, 0.5 ,NULL, SYSDATE, NULL, DEFAULT);
