...
SELECT ORDER_ID 주문번호, ORDER_DATE 주문날짜, STATUS 처리상태 FROM ORDERS
...
SELECT ORDER_ID 주문번호, PRODUCT_NAME 상품명, QUANTITY 수량, PRICE_PER_UNIT 개별금액, PRICE_PER_UNIT * QUANTITY 주문별금액합계 FROM ORDERS
