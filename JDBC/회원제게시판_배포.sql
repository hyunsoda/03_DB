...
TO_CHAR(ENROLL_DT,'YYYY"년" MM"월" DD"일" HH24:MISS') ENROLL_DT
FROM "MEMBER"
...
SELECT MEMBER_ID, MEMBER_NM, MEMBER_GENDER FROM "MEMBER";
...
WHERE DELETE_FL = 'N'
ORDER BY BOARD_NO DESC; -- 최신 작성


-- 게시글 상세 조회
SELECT BOARD_NO, BOARD_TITLE, BOARD_CONTENT, MEMBER_NO, MEMBER_NM, READ_COUNT, CREATE_DT FROM BOARD
JOIN MEMBER USING (MEMBER_NO)
WHERE DELETE_FL = 'N'
AND BOARD_NO = ?;
