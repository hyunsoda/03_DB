...
CREATE USER spring_ash IDENTIFIED BY spring1234;

GRANT CONNECT, RESOURCE TO spring_ash;

ALTER USER spring_ash DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
...
-- PROFILE_IMG 에는 진짜 사진이 올라가는 것이 아닌 사진이 저장된 경로가 올라갈 것
...
UPDATE MEMBER SET
MEMBER_PW ='$2a$10$thJRZcQR.T/cTSb3CfLOYeOMHkUDvTsWkEBnkxIaoo3BTY7WHCI8i'
WHERE MEMBER_NO =1;
