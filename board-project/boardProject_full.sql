...
INSERT INTO "MEMBER" VALUES (2,'user01@khu.ac.kr','$2a$10$LLOb4RY8E0FMbBbmFkJwnu.7L68gUZiJiybgWesmW7BkbUrNPOz2O', '유저일','01012345678',NULL, NULL,DEFAULT,DEFAULT,DEFAULT);
INSERT INTO "MEMBER" VALUES (3,'user02@khu.ac.kr','$2a$10$LLOb4RY8E0FMbBbmFkJwnu.7L68gUZiJiybgWesmW7BkbUrNPOz2O', '유저이','01012345678',NULL, NULL,DEFAULT,DEFAULT,DEFAULT);
...
BEGIN
	FOR I IN 1..2000 LOOP
		...
		VALUES(
			...
			DEFAULT, DEFAULT,
			CEIL( DBMS_RANDOM.VALUE(1, 2000) ), -- 게시글번호
			1, -- 댓글작성회원번호
			NULL -- 부모댓글번호
		);
	END LOOP;
...
ALTER TABLE "CHATTING_ROOM" ADD CONSTRAINT "FK_OPEN_MEMBER"
FOREIGN KEY ("OPEN_MEMBER") REFERENCES "MEMBER";

ALTER TABLE "CHATTING_ROOM" ADD CONSTRAINT "FK_PARTICIPANT"
...
ALTER TABLE "MESSAGE" ADD CONSTRAINT "FK_SENDER_NO"
